...
What is buffer overflow? buffer overflow can be divided into two big section. One is BOF in stack section, and the other is heap section overflow.(Stack and Heap is a field of running process structure in memory)
